/*******************************************************************************
 * dnAnimationControllerEx_RCCar_RemoteControl generated by Eliot.UELib using UE Explorer.exe.
...
defaultproperties
{
    ...
    AnimationGrids(0)=(AnimationGridName=Control_Grid,AnimationChannel=(ChannelName=Base,ChannelLink=0,bLinkedToBlock=false),AnimGridSequence=u_rctransmitter_standact_aimgrid,bIs3DGrid=false,AnimationLink=0)
}