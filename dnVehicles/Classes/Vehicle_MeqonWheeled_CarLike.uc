/*******************************************************************************
 * Vehicle_MeqonWheeled_CarLike generated by Eliot.UELib using UE Explorer.exe.
...
simulated function VDifferential BuildAxleTemplate(out SCarWheelAxle AxleTemplate)
{
    ...
    BaseLeftName = EvaluateCompare(AxleTemplate.AxleBaseTag, 'l');
    BaseRightName = EvaluateCompare(AxleTemplate.AxleBaseTag, 'R');
    ...
    if(i < 2)
    {
        ...
        AxleTemplate.Wheels[i].SetWheelOffsets(self, Vect(AxleTemplate.AxleOffset, (1 - float(2 * i)) * AxleTemplate.AxleWidth, AxleTemplate.AxleHeight));
        AxleTemplate.Wheels[i].bFlipWheel = i == 1;
        ...
        // End:0x25C
        if((AxleTemplate.Wheels[i].WheelProps.WheelClass == none) && IsA(AxleTemplate.Wheels[i].WheelProps.WheelClass, class'VehicleSpecialPart_TireEx'))
        {
