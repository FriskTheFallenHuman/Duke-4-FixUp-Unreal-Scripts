...
function Created()
{
    super.Created();
    SelectedTab = none;
    TabArea = UWindowTabControlTabArea(CreateWindow(class'UWindowTabControlTabArea', 0, 0, (WinWidth - float(10)) - float(LookAndFeel.SBPosIndicator.W * 2), LookAndFeel.Size_TabAreaHeight + LookAndFeel.Size_TabAreaOverhangHeight));
    TabArea.bAlwaysOnTop = true;
    LeftButton = UWindowTabControlLeftButton(CreateWindow(class'UWindowTabControlLeftButton', WinWidth - float(20), 0, 10, 12));
    RightButton = UWindowTabControlRightButton(CreateWindow(class'UWindowTabControlRightButton', WinWidth - float(10), 0, 10, 12));
    return;
}
...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    {
        TabArea.WinWidth = (WinWidth - float(10)) - float(LookAndFeel.SBPosIndicator.W * 2);
    }
...
function Paint(Canvas C, float X, float Y)
{
    ...
    DrawStretchedTextureSegment(C, 0, 0, WinWidth, LookAndFeel.Size_TabAreaHeight * float(TabArea.TabRows), float(R.X), float(R.Y), float(R.W), float(R.h), t);
    return;
}
