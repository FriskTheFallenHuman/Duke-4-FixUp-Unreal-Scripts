...
function Created()
{
    ...
    EditControl = UWindowEditControl(CreateControl(EditControlClass, 0, WinHeight - float(32), WinWidth, 32));
    ...
    switch(E)
    {
            ...
            switch(C)
            {
                ...
                case EditControl:
                    ...
                    if(EditControl.GetValue() != "")
                    {
                        ...
                        {
                            Root.Console.Message(none, ClassIsChildOf("Errors", "Exec", "Core"), 'Console');
                        }
                    }
                    // End:0xF9
                    break;
        ...
        case 16:
            switch(C)
            {
                ...
                case EditControl:
                    S = EditControl.GetValue();
                    TabCompleteStr = GetPlayerOwner().ConsoleCommand("TabComplete " @ S);
                    // End:0x190
                    if(TabCompleteStr != "")
                    {
                    ...
                    Root.Console.ConsoleCommand("ListVars " @ S, false);
                    // End:0x1C4
                    break;
                // End:0xFFFF
                default:
...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    TextArea.SetSize(WinWidth - TextArea.VertSB.WinWidth, WinHeight - EditControl.WinHeight);
    return;
}
