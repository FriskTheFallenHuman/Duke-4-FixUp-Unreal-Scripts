...
function Created()
{
    ClientArea = UWindowGridClient(CreateWindow(class'UWindowGridClient', 0, 0, WinWidth - float(LookAndFeel.SBPosIndicator.W), WinHeight));
    VertSB = UWindowVScrollbar(CreateWindow(class'UWindowVScrollbar', 1, 1, 1, 1));
    VertSB.bAlwaysOnTop = true;
    VertSB.bInBevel = true;
    VertSB.HideWindow();
    HorizSB = UWindowHScrollbar(CreateWindow(class'UWindowHScrollbar', 0, WinHeight - float(LookAndFeel.SBPosIndicator.W), WinWidth, float(LookAndFeel.SBPosIndicator.h)));
