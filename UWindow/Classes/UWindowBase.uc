...
static function Object BuildObjectWithProperties(string Text)
{
    ...
    C = class<Object>(SaveConfigFile(ObjectClass, class'Class'));
    O = new C;
    J0x86:
    ...
    if(Text != "")
    {
        ...
        if(i == -1)
        {
            Localize((("Missing value for property " $ ObjectClass) $ ".") $ Text);
            PropertyName = Text;
            PropertyValue = "";            
        }
        else
        ...
        if(Left(Text, 1) == "\"")
        {
            ...
            if(i == -1)
            {
                Localize((("Missing quote for " $ ObjectClass) $ ".") $ PropertyName);
                return O;
            }
            ...
            if((temp != "") && temp != ",")
            {
                Localize((("Missing comma after close quote for " $ ObjectClass) $ ".") $ PropertyName);
            }
            Text = Mid(Text, i + 2);            
        }
        else
        ...
        O.GetEnum(PropertyName, PropertyValue);
        // [Loop Continue]
        goto J0x86;
    }
    return O;
