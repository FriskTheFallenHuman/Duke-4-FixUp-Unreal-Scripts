...
event Trigger(Actor Other, Pawn EventInstigator)
{
    ...
    // End:0xAA [Loop If]
    if(i < string(EffectSpawners))
    {
        // End:0x2C
        if(EffectSpawners[i] != none)
        {
            // [Explicit Continue]
            goto J0xA0;
        }
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    i = string(EffectSpawners) - 1;
    J0x21:

    // End:0x4E [Loop If]
    if(i >= 0)
    {
        PrecacheIndex.RegisterMaterialClass(EffectSpawners[i]);
        -- i;
        // [Loop Continue]
        goto J0x21;
    }
