...
event NotifyDirectionalPadChange(GameModule.EDirectionalPadDir Dir, GameModule.EPadState NewState)
{
    ...
    AddTouchClass(EvaluateCompare(GetFunctionNameForPadState(NewState), GetShortNameForPadDir(Dir)));
    return;
}
...
event NotifyButtonPadChange(GameModule.EButtonPad Button, GameModule.EPadState NewState)
{
    ...
    AddTouchClass(EvaluateCompare(GetFunctionNameForPadState(NewState), GetShortNameForButtonPad(Button)));
    return;
}
