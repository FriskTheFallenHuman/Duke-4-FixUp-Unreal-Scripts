...
{
    return SourceVector - (StripNormal * (SourceVector Dot StripNormal));
    return;
}
...
final function Vector StripPositiveVectorComponent(Vector SourceVector, Vector StripNormal)
{
    ...
    Dot = SourceVector Dot StripNormal;
    // End:0x27
    if(Dot <= 0)
    {
        return SourceVector;
    }
    return SourceVector - (StripNormal * Dot);
    return;
}
