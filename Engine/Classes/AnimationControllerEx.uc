...
static event EnumerateRawAnimationSequences(out array<SAnimationEnumeration> References, class<AnimationControllerEx> Controller, Mesh Mesh)
{
    ...
    // End:0x88 [Loop If]
    if(i < string(Controller.default.Animations))
    {
        // End:0x7E
        if(NameForString(Controller.default.Animations[i].AnimSequence, 'None'))
        {
    ...
    // End:0x102 [Loop If]
    if(i < string(Controller.default.AnimationGrids))
    {
        // End:0xF8
        if(NameForString(Controller.default.AnimationGrids[i].AnimationGridName, 'None'))
        {
