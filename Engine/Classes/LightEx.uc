...
{
    // Pos:0x000
    reliable if(((int(Role) == int(ROLE_Authority)) && bNetInitial) && ! bStatic)
    ...
    // Pos:0x023
    reliable if((int(Role) == int(ROLE_Authority)) && ! bStatic)
...
simulated function PostNetInitial()
{
    ...
    // End:0x52
    if(LightShadowSource != none)
    {
        LightShadowSource = FindActor(class'Actor', LightShadowSourceTag);
    }
    // End:0x6D
    if(NameForString(LightAmbientSoundName, 'None'))
    {
    ...
    if(NameForString(LightAmbientSoundName, 'None'))
    {
        switch(LightStyle)
        {
            ...
            case 7:
                ...
                // End:0x5C
                if(CurrentColor.X > float(0))
                {
                    Div += 1;
                }
                // End:0x79
                if(CurrentColor.Y > float(0))
                {
                    Div += 1;
                }
                // End:0x96
                if(CurrentColor.Z > float(0))
                {
                    Div += 1;
                }
                // End:0xD4
            ...
            case 6:
                ...
                {
                    Div += 1;
                    X = (255 * CurrentColor.X) / float(LightColor.R);
                }
                // End:0x17E
                if(int(LightColor.G) > 0)
                {
                    Div += 1;
                    Y = (255 * CurrentColor.Y) / float(LightColor.G);
                }
                // End:0x1BF
                if(int(LightColor.B) > 0)
                {
                    Div += 1;
                    Z = (255 * CurrentColor.Z) / float(LightColor.B);
                }
                // End:0x1EE
                if(Div > 0)
                {
        ...
        InVolume *= Lerp(Brightness, LightAmbientSoundMinScale, LightAmbientSoundMaxScale);
        return FClamp(InVolume, 0, 1);
    }
