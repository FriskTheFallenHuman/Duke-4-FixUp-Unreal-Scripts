...
function GrabUsed(Pawn Grabber)
{
    ...
    // End:0x55
    if((Grabber == none) && ! bRequireHunger || Grabber.Health < Grabber.GetHealthCap())
    {
        Consume(Grabber);
    }
    return;
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.InitAnimationControllerEx(class'DukePlayer'.default.VoicePack, 'Consume');
    return;
}
