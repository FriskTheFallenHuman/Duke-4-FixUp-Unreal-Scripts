...
simulated function Trigger(Actor Other, Pawn EventInstigator)
{
    ...
    if(bSplashOnTrigger)
    {
        ...
        ParseURL(Other.Location, TriggerStrength, TriggerRadius);
        // End:0x6B
    ...
    // End:0x122
    if(NameForString(TriggerEvent, 'None') && Level.GameTimeSeconds >= LastTriggerTimeSeconds)
    {
        ...
        if(bDebug)
        {
            BroadcastMessage((((string(self) @ ": Doing event: ") @ string(TriggerEvent)) @ ",") @ string(TriggerEventCount));
        }
        // End:0x122
...
event TakeDamage(Pawn Instigator, float Damage, Vector DamageOrigin, Vector DamageDirection, class<DamageType> DamageType, optional name HitBoneName, optional Vector DamageStart)
{
    ...
    {
        ParseURL(DamageOrigin, Instigator.Weapon.WeaponConfig.default.HitWaterStrength * DamageStrengthScale, Instigator.Weapon.WeaponConfig.default.HitWaterRadius * DamageRadiusScale);
        // End:0x138
        if(NameForString(DamageEvent, 'None') && Level.GameTimeSeconds >= LastDamageTimeSeconds)
        {
            ...
            if(bDebug)
            {
                BroadcastMessage((((string(self) @ ": Damage event: ") @ string(DamageEvent)) @ ",") @ string(DamageEventCount));
            }
            // End:0x138
