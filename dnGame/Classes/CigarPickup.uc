/*******************************************************************************
 * CigarPickup generated by Eliot.UELib using UE Explorer.exe.
...
{
    // End:0x32
    if(User.bIsPlayerPawn && PlayerPawn(User).CigarAttachment == none)
    {
        return false;
    }
    // End:0x55
    if((IsMyDigs()) && User.CarriedActor == none)
    {
        return false;
    }
