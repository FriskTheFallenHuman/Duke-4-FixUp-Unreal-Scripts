...
simulated function AttachPawnSuccess(Pawn Attachee, optional bool bForced)
{
    ...
    SetDesiredRotation((Attachee.Location - Vect(0, 0, Attachee.CollisionHeight)) - TransformVectorByRot(Attachee.PrePivot, Attachee.Rotation));
    kickRotation = Rotator(DoorMover.GetDoorCenter() - Attachee.Location);
    kickRotation.Pitch = Attachee.Rotation.Pitch;
    DisableDesiredRotation_Roll(kickRotation);
    // End:0xBA
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.InitAnimationControllerEx(class'VoicePack_Duke', 'DoorKick');
    return;
}
