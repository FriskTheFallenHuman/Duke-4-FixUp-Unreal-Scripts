...
event Touch(Actor Other)
{
    ...
    Other.TakeDamage(none, dmg, Other.Location, Vect(0, 0, 1), class'ExplosionDamage');
    return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'FlyByPlane_Fighter_AltFire');
    return;
}
