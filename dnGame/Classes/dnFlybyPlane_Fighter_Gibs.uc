/*******************************************************************************
 * dnFlybyPlane_Fighter_Gibs generated by Eliot.UELib using UE Explorer.exe.
...
function PostBeginPlay()
{
    ...
    // End:0x3F
    if(CrashingEffect == none)
    {
        CrashingEffect.Enabled = true;
    }
    TraceFire(5, false, 'TurnOffSmoke');
    return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'FlyByPlane_Fighter_Crashing');
    return;
}
