...
simulated event ScriptGetActorColor()
{
    ...
    C.A = byte(255 * FMin((Level.GameTimeSeconds - LeftFlashStartTime) / FlashDuration, 1));
    Sleep('Generic0', C);
    C.A = byte(255 * FMin((Level.GameTimeSeconds - RightFlashStartTime) / FlashDuration, 1));
    Sleep('Generic1', C);
