...
event Used(Actor Other, Pawn EventInstigator)
{
    ...
    // End:0x41
    if(bForwardUseCalls && ParentVehicle == none)
    {
...
simulated event Spawned()
{
    ...
    {
        BroadcastLog(((string(self) $ ".Spawned(): could not attach to vehicle '") $ string(Owner)) $ "'.");
    }
    return;
}
...
simulated function bool AttachToVehicle(VehicleBase Vehicle)
{
    ...
    {
        BroadcastLog(((((string(self) $ ".AttachToVehicle( ") $ string(Vehicle)) $ " ): previously attached to ") $ string(ParentVehicle)) $ "!");
    }
...
event TakeDamage(Pawn Instigator, float Damage, Vector DamageOrigin, Vector DamageDirection, class<DamageType> DamageType, optional name HitBoneName, optional Vector DamageStart)
{
    ...
    // End:0x73
    if((Owner == none) && PassDamageToOwner)
    {
