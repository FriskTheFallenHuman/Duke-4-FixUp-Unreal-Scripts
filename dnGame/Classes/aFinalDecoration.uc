/*******************************************************************************
 * aFinalDecoration generated by Eliot.UELib using UE Explorer.exe.
...
{
    PrecacheIndex.RegisterAnimationControllerEntry(ChannelInfo.ShowSmack);
    PrecacheIndex.RegisterAnimationControllerEntry(ChannelInfo.ShowOffTex);
    PrecacheIndex.GetColorForPosition(ChannelInfo.ShowSound);
    PrecacheIndex.GetColorForPosition(ChannelInfo.ShowOffSound);
    PrecacheIndex.PlayPhysicsImpactSound(ChannelInfo.ShowSoundAmbient);
    PrecacheIndex.PlayPhysicsImpactSound(ChannelInfo.ShowOffSoundAmbient);
    return;
}
