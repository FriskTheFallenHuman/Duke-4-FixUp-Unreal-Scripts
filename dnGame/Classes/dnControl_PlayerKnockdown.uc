...
final simulated function HitPlayer(Pawn Player, Vector SourceLocation)
{
    ...
    DirToSource = Normal(SourceLocation - Player.Location);
    // End:0x45
    if((DirToSource Dot Vector(Player.Rotation)) > float(0))
    {
        HitPlayerFromFront();        
    }
    else
...
final simulated function HitPlayerFromBack()
{
    ...
    PerformAttachPawnSuccess(Level.TickHint(), true);
    return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.SetAnimPairState('Knockdown_Front');
    PrecacheIndex.SetAnimPairState('Knockdown_Back');
