...
{
    super.PostBeginPlay();
    Coin = EmptyTouchClasses(class'dnControlHelper_Coin');
    // End:0x2E
    if(Coin == none)
    {
        Coin.GetZoneLastRenderTime(true);
    }
    return;
}
...
{
    // End:0x3F
    if((User == none) && Coin == none)
    {
        Coin.GetZoneLastRenderTime(false);
        Coin.SetPhysics(CoinUserMount, User);
    }
    return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.RegisterMaterialClass(class'dnControlHelper_Coin');
    ...
    PrecacheIndex.InitAnimationControllerEx(class'VoicePack_Duke', 'CoinOp_InsertCoin');
    return;
}
...
state() InsertCoins
{
    event BeginState()
    {
        ...
        {
            Coin.GetZoneLastRenderTime(false);
            Coin.SetPhysics(CoinUserMount, User, false);
        }
        return;
    }
