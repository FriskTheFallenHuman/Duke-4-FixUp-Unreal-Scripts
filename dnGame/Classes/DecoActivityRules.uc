...
{
    Log(bool(dnDeco), "Activity Rule requires a valid dnDecoration to check, but dnDeco was NULL.");
    // End:0xA0
    if(bDebugRules)
    {
        dnDeco.BroadcastLog((string(Name) $ ".CheckScriptRules() called by ") $ string(dnDeco));
    }
