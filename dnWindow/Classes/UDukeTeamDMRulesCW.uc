...
function BeforePaintOther(Canvas C, float X, float Y, int Left, int Right, int Top, int CenterWidth)
{
    ...
    ForceTeamBalanceLabel.WinLeft = (ForceTeamBalanceCheck.WinLeft - float(14)) - ForceTeamBalanceLabel.WinWidth;
    ...
    FriendlyFireLabel.WinLeft = (FriendlyFireCheck.WinLeft - float(14)) - FriendlyFireLabel.WinWidth;
