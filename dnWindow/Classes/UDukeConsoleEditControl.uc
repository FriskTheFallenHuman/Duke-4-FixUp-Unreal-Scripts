...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    switch(Align)
    {
        // End:0xB6
        case 0:
            EditAreaDrawX = (WinWidth - EditBoxWidth) + float(1);
            TextX = 2;
            // End:0x114
            break;
        // End:0xDB
        ...
        // End:0x111
        case 2:
            EditAreaDrawX = (WinWidth - EditBoxWidth) / float(2);
            TextX = (WinWidth - tW) / float(2);
            // End:0x114
            break;
        // End:0xFFFF
        default:
