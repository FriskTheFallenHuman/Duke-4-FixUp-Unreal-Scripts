...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    RestartVoteButton.WinLeft = (WinWidth - RestartVoteButton.WinWidth) / float(2);
    NextMapVoteButton.AutoSize(C);
    NextMapVoteButton.WinLeft = (WinWidth - NextMapVoteButton.WinWidth) / float(2);
    RestartVoteButton.WinTop = (WinHeight - (RestartVoteButton.WinHeight + NextMapVoteButton.WinHeight)) / float(2);
