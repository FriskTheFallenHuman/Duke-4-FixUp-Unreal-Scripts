...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    UseFilterCheck.WinTop = (FiltersButton.WinHeight - UseFilterCheck.WinHeight) / float(2);
    ...
    NetSpeedCombo.WinTop = (FiltersButton.WinHeight - NetSpeedCombo.WinHeight) / float(2);
    ...
    StatusLabel.WinTop = RefreshButton.WinTop + ((RefreshButton.WinHeight - StatusLabel.WinHeight) / float(2));
    return;
}
