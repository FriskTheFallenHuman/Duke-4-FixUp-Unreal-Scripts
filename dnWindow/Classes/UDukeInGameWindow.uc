...
function Created()
{
    ...
    TopButton.xOffset = (20 / 1024) * XMod;
    ...
    if(i < NumOptions)
    {
        ...
        OptionButtons[i].xOffset = (20 / 1024) * XMod;
    ...
    BottomButton.xOffset = (20 / 1024) * XMod;
...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    if(i < NumOptions)
    {
        ...
        OptionButtons[i].xOffset = (20 / 960) * XMod;
        OptionButtons[i].WinLeft = xOffset;
        OptionButtons[i].WinTop = YPos + (((32 / 720) * YMod) * float(i + 1));
        ++ i;
        // [Loop Continue]
        goto J0x188;
    }
    BottomButton.SetSize(XWidth, YHeight);
    BottomButton.xOffset = (20 / 960) * XMod;
    BottomButton.WinLeft = xOffset;
    BottomButton.WinTop = YPos + (((32 / 720) * YMod) * float(NumOptions + 1));
    return;
}
...
function Tick(float Delta)
{
    ...
    if(bFadeIn)
    {
        FadeFactor += (Delta * float(700));
        // End:0x1B5
        if(FadeFactor > float(100))
        {
            FadeFactor = 100;
            bFadeIn = false;
        }
