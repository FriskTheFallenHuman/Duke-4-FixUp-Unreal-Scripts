/*******************************************************************************
 * UDukeSceneSoundBoard generated by Eliot.UELib using UE Explorer.exe.
...
{
    SoundInfo.SimpleSingleSound = Sound(SaveConfigFile(Command, class'Sound'));
    // End:0x50
    if(SoundInfo.SimpleSingleSound == none)
    {
...
function Tick(float Delta)
{
    ...
    GetPlayerOwner().PlayAnimEx(25, 0);
    return;
}
