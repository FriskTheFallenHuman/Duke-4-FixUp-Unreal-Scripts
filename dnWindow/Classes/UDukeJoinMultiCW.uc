...
function Created()
{
    ...
    ServerBrowser = UDukeServerBrowserCW(CreateWindow(class'UDukeServerBrowserCW', 10, 70, WinWidth - float(20), WinHeight - float(70)));
...
function Resized()
{
    ...
    ServerBrowser.SetSize(WinWidth - float(20), WinHeight - float(70));
