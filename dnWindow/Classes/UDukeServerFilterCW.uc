...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    CColLeft = int(WinWidth / float(2)) - 60;
    CColRight = int(WinWidth / float(2)) - 46;
    ...
    EnableFiltersLabel.WinLeft = (EnableFiltersCheck.WinLeft - float(14)) - EnableFiltersLabel.WinWidth;
    ...
    GameTypesLabel.WinLeft = float(CColLeft) - GameTypesLabel.WinWidth;
    ...
    MapNameLabel.WinLeft = float(CColLeft) - MapNameLabel.WinWidth;
    ...
    MinPlayersLabel.WinLeft = (WinWidth - ((W + W2) + float(32))) / float(2);
    ...
    MaxPingLabel.WinLeft = (MinPlayersEdit.WinLeft - float(14)) - MaxPingLabel.WinWidth;
    ...
    BuddyListLabel.WinLeft = (BuddyListCheck.WinLeft - float(14)) - BuddyListLabel.WinWidth;
    BuddyListLabel.WinTop = BuddyListCheck.WinTop + float(10);
    BuddyList.SetSize(300, 150);
    BuddyList.WinLeft = (WinWidth - BuddyList.WinWidth) / float(2);
    ...
    NewBuddyLabel.WinLeft = float(CColLeft) - NewBuddyLabel.WinWidth;
...
function BuildBuddyFilter()
{
    ...
    ServerBrowser.StaticSaveConfig();
    return;
}
