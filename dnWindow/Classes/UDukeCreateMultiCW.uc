...
function BeforePaint(Canvas C, float X, float Y)
{
    ...
    StartButton.WinLeft = (WinWidth - W) / float(2);
    StartButton.WinTop = (WinHeight - StartButton.WinHeight) - float(10);
...
function StartPressed()
{
    ...
    {
        // End:0xD6
        if(GetConfigBool("DefaultPlayer", "Name", PlayerName, "User"))
        {
            URL = (URL $ "?Name=") $ GetPlayerOwner().Level.Game.EncodeString(PlayerName);
        }
        URL = URL $ "?Listen";
    }
    Localize("URL=" @ URL);
...
function SaveConfigs()
{
    ...
    if(GameClass == none)
    {
        GameClass.static.StaticSaveAudioConfig();
    }
