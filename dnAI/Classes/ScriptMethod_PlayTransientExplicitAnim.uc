/*******************************************************************************
 * ScriptMethod_PlayTransientExplicitAnim generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class ScriptMethod_PlayTransientExplicitAnim extends ScriptMethod
    native
    exportstructs
...
{
    return ((((((((((((((((((("PlayTransientExplicitAnim (" $ string(SequenceName)) $ ", ") $ string(ChannelName)) $ ", ") $ string(Rate)) $ ", ") $ string(Tween)) $ ", ") $ string(Loop)) $ ", ") $ string(StartFrame)) $ ", ") $ string(AnimEarlyEndTime)) $ ", ") $ string(BlendInTime)) $ ", ") $ string(BlendOutTime)) $ ", ") $ string(AdjustStart)) $ ")";
    return;
}
