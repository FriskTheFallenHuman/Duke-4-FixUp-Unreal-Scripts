/*******************************************************************************
 * ScriptMethod_SetEyeTarget generated by Eliot.UELib using UE Explorer.exe.
...
{
    return ((((((((((((((((("SetEyeTarget (" $ string(TargetActorTag)) $ ", ") $ string(TargetBoneName)) $ ", ") $ string(DynamicLoadObject(class'EAITargetStackOp', int(TargetStackOp)))) $ ", ") $ string(TargetLifeTime)) $ ", ") $ string(BlendTime)) $ ", ") $ string(AngularThresh)) $ ", ") $ string(TrackRate)) $ ", ") $ string(RemoveBeyondConsts)) $ ", ") $ TargetIDString) $ ")";
    return;
}
