...
{
    // End:0x20
    if(IsA(MyWeapon.Class, class'Pistol'))
    {
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    if(Mesh.Name != 'edf_soldiere')
    {
        PrecacheIndex.RegisterMaterialClass(class'DylanCorpse');
    }
    ...
    {
        PrecacheIndex.InitAnimationControllerEx(VoicePack, 'CPR_Breath');
        PrecacheIndex.InitAnimationControllerEx(VoicePack, 'CPR_Inhale');
        PrecacheIndex.InitAnimationControllerEx(VoicePack, 'CPR_Push');
...
event EnumerateWeaponClasses(PrecacheIndex PrecacheIndex, out array< class<Weapon> > WeaponClasses)
{
    ...
    {
        // End:0x82
        if((PrecacheIndex.MapName ~= "Map04B") || PrecacheIndex.MapName ~= "Map04C")
        {
        ...
        {
            // End:0xC5
            if(PrecacheIndex.MapName ~= "Map05")
            {
                WeaponClasses[string(WeaponClasses)] = class'MachineGun_EDF';
                WeaponClasses[string(WeaponClasses)] = class'Shotgun_EDF';                
            }
            ...
            {
                // End:0xF6
                if(PrecacheIndex.MapName ~= "Map08")
                {
                    WeaponClasses[string(WeaponClasses)] = class'MachineGun_EDF';                    
                }
                else
                {
                    ...
                    {
                        // End:0x17D
                        if(PrecacheIndex.MapName ~= "Map16B")
                        {
                            WeaponClasses[string(WeaponClasses)] = class'MachineGun_EDF';
                            WeaponClasses[string(WeaponClasses)] = class'Shotgun_EDF';                            
                        }
