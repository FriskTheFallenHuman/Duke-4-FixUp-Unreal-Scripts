/*******************************************************************************
 * ScriptMethod_GotoAndUseItem generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class ScriptMethod_GotoAndUseItem extends ScriptMethod_GotoBase
    native
    exportstructs
...
{
    return ((((((("GotoAndUseItem (" $ string(TargetItemTag)) $ ", ") $ string(Run)) $ ", ") $ string(InputDispatcherTag)) $ ", ") $ string(AttachedEvent)) $ ")";
    return;
}
