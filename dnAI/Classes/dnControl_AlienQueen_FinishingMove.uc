...
simulated function PlayUserAnim()
{
    ...
    // End:0x71
    if((NameForString(States[CurrentStateIndex].UserAnimName, 'None') && AlienQueen == none) && AlienQueen.AnimationController == none)
    {
...
state() idle
{
    ...
    function UpdateUserLift()
    {
        ...
        // End:0xAE
        if(NameForString(GridName, 'None'))
        {
            User.AnimationController.SetAnimGridState(GridName, UserLiftVal);
            // End:0xAE
            if((AlienQueen == none) && AlienQueen.AnimationController == none)
            {
