/*******************************************************************************
 * ScriptMethod_SetTarget generated by Eliot.UELib using UE Explorer.exe.
...
{
    return ((((((("SetTarget (" $ string(TargetActorTag)) $ ", ") $ string(ForceUpdate)) $ ", ") $ string(AllowClear)) $ ", ") $ string(SuspendTargetEval)) $ ")";
    return;
}
