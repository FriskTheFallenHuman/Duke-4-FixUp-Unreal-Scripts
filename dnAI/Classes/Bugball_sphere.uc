...
function Activate()
{
    ...
    SetRotation(18);
    SetPhysicsPose(Vect(0, 0, 0), 1);
    KPushGeneratedSimpleState(Vect(0, 0, 0), 1);
    KHurtRadiusActivity(Vect(0, 0, 0), 1);
    StopPersistantPhysicsEffects(Vect(0, 0, 0), 1);
    MyCylinderHelper.SetDesiredRotation(Location, true);
