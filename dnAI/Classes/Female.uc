/*******************************************************************************
 * Female generated by Eliot.UELib using UE Explorer.exe.
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.SetChannelGridState('Anim_Idle', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Walk', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_WalkBackwards', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Run', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_RunBackwards', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnLeft45', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnLeft180', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnRight45', class'acStripper', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnRight180', class'acStripper', Mesh);
    // End:0x1DB
    if(PrecacheIndex.MapName ~= "Map01")
    {
        PrecacheIndex.SetChannelEventState(Mesh, 'a_normal_stand_idle_01');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_normal_stand_greet_01');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map01_female_clap01');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map01_female_clap02');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map01_female_clap03');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map01_talkshow_audience_idle01');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map01_talkshow_audience_idle02');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map01_talkshow_audience_idle03');
    }
    // End:0x20E
    if(PrecacheIndex.MapName ~= "Map09")
    {
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map13_stripper_start_to_first_position');
    }
    return;
}
