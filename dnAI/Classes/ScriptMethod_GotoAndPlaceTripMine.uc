/*******************************************************************************
 * ScriptMethod_GotoAndPlaceTripMine generated by Eliot.UELib using UE Explorer.exe.
...
{
    return ((((((("GotoAndPlaceTripMine (" $ string(PlaceTargetActorTag)) $ ", ") $ string(RangeFromPlaceTarget)) $ ", ") $ string(TripMineClass)) $ ", ") $ string(Run)) $ ")";
    return;
}
