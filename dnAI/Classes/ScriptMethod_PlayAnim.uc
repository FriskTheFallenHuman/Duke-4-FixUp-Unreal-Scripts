/*******************************************************************************
 * ScriptMethod_PlayAnim generated by Eliot.UELib using UE Explorer.exe.
...
{
    return (((((((((((((("PlayAnim (" $ string(DynamicLoadObject(class'EAIAnimXType', int(AnimType)))) $ ", ") $ string(AnimName)) $ ", ") $ string(UseExactAnimName)) $ ", ") $ string(ExitTime)) $ ", ") $ string(Infinite)) $ ", ") $ string(FaceActorTag)) $ ", (") $ string(FacePos)) $ ")") $ ")";
    return;
}
