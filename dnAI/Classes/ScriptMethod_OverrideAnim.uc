/*******************************************************************************
 * ScriptMethod_OverrideAnim generated by Eliot.UELib using UE Explorer.exe.
...
{
    return ((((((((((((((((((((("OverrideAnim (" $ string(AnimName)) $ ", ") $ string(SequenceName)) $ ", ") $ string(ChannelName)) $ ", ") $ string(Rate)) $ ", ") $ string(Tween)) $ ", ") $ string(Loop)) $ ", ") $ string(StartFrame)) $ ", ") $ string(AnimEarlyEndTime)) $ ", ") $ string(BlendInTime)) $ ", ") $ string(BlendOutTime)) $ ", ") $ string(AdjustStart)) $ ")";
    return;
}
