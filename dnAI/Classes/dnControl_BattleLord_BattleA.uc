...
simulated function PlayUserAnim()
{
    ...
    // End:0x71
    if((NameForString(States[CurrentStateIndex].UserAnimName, 'None') && Battlelord == none) && Battlelord.AnimationController == none)
    {
...
state() idle
{
    event BeginState()
    {
        TraceFire(Battlelord.StrengthTapTimeout, false, 'FailTimer');
    ...
    function UpdateUserLift()
    {
        ...
        // End:0x9E
        if((Battlelord == none) && Battlelord.AnimationController == none)
        {
