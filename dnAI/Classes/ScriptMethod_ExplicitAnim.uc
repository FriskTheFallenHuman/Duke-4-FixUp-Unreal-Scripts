/*******************************************************************************
 * ScriptMethod_ExplicitAnim generated by Eliot.UELib using UE Explorer.exe.
...
{
    return (((((((((((((((((((((((((("ExplicitAnim (" $ string(DynamicLoadObject(class'EAIAnimXType', int(AnimType)))) $ ", ") $ string(SequenceName)) $ ", ") $ string(ChannelName)) $ ", ") $ string(Rate)) $ ", ") $ string(Tween)) $ ", ") $ string(Loop)) $ ", ") $ string(AnimEarlyEndTime)) $ ", ") $ string(BlendInTime)) $ ", ") $ string(BlendOutTime)) $ ", ") $ string(AdjustStart)) $ ", ") $ string(ExitTime)) $ ", ") $ string(FaceActorTag)) $ ", (") $ string(FacePos)) $ ")") $ ")";
    return;
}
