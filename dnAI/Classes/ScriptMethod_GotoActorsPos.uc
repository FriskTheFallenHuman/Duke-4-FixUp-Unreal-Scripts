/*******************************************************************************
 * ScriptMethod_GotoActorsPos generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class ScriptMethod_GotoActorsPos extends ScriptMethod_GotoBase
    native
    exportstructs
...
{
    return ((((((((((((("GotoActorsPos (" $ string(TargetActorTag)) $ ", (") $ string(TargetPosVar)) $ "), ") $ string(Range)) $ ", ") $ string(RangeVar)) $ ", ") $ string(DynamicLoadObject(class'EAIFocus', int(Focus)))) $ ", ") $ string(FocusActorTag)) $ ", ") $ string(Run)) $ ")";
    return;
}
