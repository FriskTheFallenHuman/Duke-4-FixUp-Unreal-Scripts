...
simulated function HandleDecoAnimEvent(EventInfo EventParms)
{
    ...
    // End:0x31
    if(EventParms.EventString ~= "crush")
    {
...
{
    // End:0x26
    if(MicrowaveInfo.MicrowaveActor == none)
    {
...
function Anim_MoveTo(Engine.BaseAI.EAIMoveSpeed MoveSpeed)
{
    ...
    // End:0x41
    if(FRand() < ChanceSqueekSFX)
    {
        // End:0x36
        if(int(CheckCondition(94)) == int(0))
        {
...
{
    // End:0x5C
    if((PrimaryTargetActor == none) && ! PrimaryTargetActor.bIsPawn || (PrimaryTargetActor.bIsPawn && Pawn(PrimaryTargetActor).PhysController_SetGroundConstraintDirection()) && ! PhysController_SetGroundConstraintDirection())
    {
        return 0;
    }
    return 1;
...
{
    // End:0x2E
    if((int(Cond_ValidShrunkenTarget()) == int(0)) && PrimaryTarget.GetTimeSinceContact() < 3)
    {
        return 0;
    }
    return 1;
...
{
    // End:0x6F
    if(((PrimaryTarget.IsValidTarget() && int(Cond_ValidShrunkenTarget()) != int(0)) && PrimaryTarget.GetTimeSinceContact() < 0.5) && VSizeSquared(Location - PrimaryTarget.GetPos()) < (MyAvoidRange * MyAvoidRange))
    {
        return 0;
    }
    return 1;
...
{
    // End:0x1C
    if(DodgeGate < Level.GameTimeSeconds)
    {
        return 0;
    }
    return 1;
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.SetChannelGridState('Anim_Idle', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_AggressiveIdle', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Walk', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_WalkBackwards', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Run', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_RunBackwards', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_SidestepLeft', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_SidestepRight', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_StrafeLeft', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_StrafeRight', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_DodgeLeft', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_DodgeRight', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnLeft45', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnLeft180', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnRight45', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_TurnRight180', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Pain', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Attack', class'acRat', Mesh);
    // End:0x232
    if(PrecacheIndex.bPlayerCanBeShrunk)
    {
        PrecacheIndex.SetChannelGridState('Anim_AttackShrunk', class'acRat', Mesh);
    }
    PrecacheIndex.SetChannelGridState('Anim_Roar', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Microwave', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_IdleMicrowave', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Carried', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Cower', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Fall1', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_Land1', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_JumpAttack', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_JumpAttack0', class'acRat', Mesh);
    PrecacheIndex.SetChannelGridState('Anim_JumpAttack1', class'acRat', Mesh);
    PrecacheIndex.SetAnimPairState('CarryRat_Use');
    PrecacheIndex.ResetServer(class'CrushingDamage');
    PrecacheIndex.ResetServer(class'MicrowaveDamage');
    PrecacheIndex.ResetServer(class'RatMeleeDamage');
    PrecacheIndex.ResetServer(class'RatMeleeDamageNoSound');
    PrecacheIndex.SetAnimState(class'Flesh_Human');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Attack');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Attack_Bite');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Attack_Claw');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Chase');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Cower');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_FootStep');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Idle');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Hiss');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Sound_Surprise');
