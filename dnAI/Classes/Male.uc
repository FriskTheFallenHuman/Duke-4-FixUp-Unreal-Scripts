...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    // End:0x19F
    if((PrecacheIndex.MapName ~= "Map01") || PrecacheIndex.MapName ~= "Map09")
    {
        PrecacheIndex.SetChannelEventState(Mesh, 'ai_a_neutral_noweapon_stand_idle_to_vending_idle');
        PrecacheIndex.SetChannelEventState(Mesh, 'ai_a_neutral_noweapon_stand_vending_idle');
        PrecacheIndex.SetChannelEventState(Mesh, 'ai_a_neutral_noweapon_stand_vending_idle_01');
        PrecacheIndex.SetChannelEventState(Mesh, 'ai_a_neutral_noweapon_stand_vending_idle_to_idle');
        PrecacheIndex.SetChannelEventState(Mesh, 'ai_a_neutral_noweapon_stand_idle_to_vending_idle');
        PrecacheIndex.SetChannelEventState(Mesh, 'a_scr_map01_talkshow_audience_idle03');
    }
    // End:0x258
    if(((((PrecacheIndex.MapName ~= "Map01") || PrecacheIndex.MapName ~= "Map06") || PrecacheIndex.MapName ~= "Map09") || PrecacheIndex.MapName ~= "Map18") || PrecacheIndex.MapName ~= "Map_mydigs")
    {
