...
{
    return ((((((((((((((((((((((((((((((((((((((((((((((((((("SetAbortable ((" $ string(MotiveSeeActor.Aborts)) $ ", ") $ string(DynamicLoadObject(class'EAIInstigatorType', int(MotiveSeeActor.InstigatorInfo.Type)))) $ ", ") $ string(MotiveSeeActor.InstigatorInfo.Tag)) $ ")") $ ", (") $ string(MotiveHearSound.Aborts)) $ ", ") $ string(DynamicLoadObject(class'EAIInstigatorType', int(MotiveHearSound.InstigatorInfo.Type)))) $ ", ") $ string(MotiveHearSound.InstigatorInfo.Tag)) $ ")") $ ", (") $ string(MotiveDamaged.Aborts)) $ ", ") $ string(DynamicLoadObject(class'EAIInstigatorType', int(MotiveDamaged.InstigatorInfo.Type)))) $ ", ") $ string(MotiveDamaged.InstigatorInfo.Tag)) $ ", ") $ string(MotiveDamaged.Threshold)) $ ")") $ ", (") $ string(MotiveBumped.Aborts)) $ ", ") $ string(DynamicLoadObject(class'EAIInstigatorType', int(MotiveBumped.InstigatorInfo.Type)))) $ ", ") $ string(MotiveBumped.InstigatorInfo.Tag)) $ ")") $ ", (") $ string(MotiveTriggered.Aborts)) $ ", ") $ string(DynamicLoadObject(class'EAIInstigatorType', int(MotiveTriggered.InstigatorInfo.Type)))) $ ", ") $ string(MotiveTriggered.InstigatorInfo.Tag)) $ ")") $ ", (") $ string(MotiveShrunk.Aborts)) $ ")") $ ", ") $ string(EgoChange)) $ ", ") $ string(AbortActorTag)) $ ", ") $ string(AbortEvent)) $ ", ") $ string(ChangeScriptTag)) $ ", ") $ string(ChangedScriptTag)) $ ", ") $ string(KeepProp)) $ ")";
    return;
}
