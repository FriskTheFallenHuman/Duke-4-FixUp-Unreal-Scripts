/*******************************************************************************
 * ScriptMethod_GuardActor generated by Eliot.UELib using UE Explorer.exe.
...
{
    return (((((((((((((((((("GuardActor (" $ string(GuardedActorTag)) $ ", ") $ string(InnerRange)) $ ", ") $ string(OuterRange)) $ ", ") $ string(AlignWith)) $ " (") $ string(AlignmentOffset)) $ ")") $ ", ") $ string(AbortRange)) $ ", ") $ string(AbortMustBeVisible)) $ ", ") $ string(AllowAvoidDanger)) $ ", ") $ string(AllowDodge)) $ ")";
    return;
}
