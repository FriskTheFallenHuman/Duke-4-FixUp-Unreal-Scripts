...
function Trigger(Actor Other, Pawn EventInstigator)
{
    ...
    {
        BroadcastLog(((((((("(" $ string(Name)) $ ", ") $ string(Level.GameTimeSeconds)) $ ") -- ScriptTrigger::Trigger (") $ string(Other)) $ ", ") $ string(EventInstigator)) $ ")");
        BroadcastLog((((("(" $ string(Name)) $ ", ") $ string(Level.GameTimeSeconds)) $ ")   -- Script:          ") $ string(Script.Name));
        BroadcastLog((((("(" $ string(Name)) $ ", ") $ string(Level.GameTimeSeconds)) $ ")   -- PushScript:      ") $ string(PushScript));
    }
    // End:0x23D
    if(NameForString(Event, 'None'))
    {
        ...
        if(DebugScriptTrigger)
        {
            BroadcastLog((((("(" $ string(Name)) $ ", ") $ string(Level.GameTimeSeconds)) $ ")   -- EventInstigator: ") $ string(EventInstigator));
            BroadcastLog((((("(" $ string(Name)) $ ", ") $ string(Level.GameTimeSeconds)) $ ")   -- MyActor:         ") $ string(MyActor));
