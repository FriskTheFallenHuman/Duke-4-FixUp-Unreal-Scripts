/*******************************************************************************
 * ScriptMethod_SetBodyTarget generated by Eliot.UELib using UE Explorer.exe.
...
{
    return ((((((((((((((("SetBodyTarget (" $ string(TargetActorTag)) $ ", ") $ string(DynamicLoadObject(class'EAITargetStackOp', int(TargetStackOp)))) $ ", ") $ string(TargetLifeTime)) $ ", ") $ string(BlendTime)) $ ", ") $ string(AngularThresh)) $ ", ") $ string(TrackRate)) $ ", ") $ string(RemoveBeyondConsts)) $ ", ") $ TargetIDString) $ ")";
    return;
}
