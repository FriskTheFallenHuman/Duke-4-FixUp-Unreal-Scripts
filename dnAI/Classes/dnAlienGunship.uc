...
event TakeDamage(Pawn Instigator, float Damage, Vector DamageOrigin, Vector DamageDirection, class<DamageType> DamageType, optional name HitBoneName, optional Vector DamageStart)
{
    ...
    // End:0x223
    if((Health < float(DamageThreshold1)) && ! bPassedThreshold1)
    {
        ...
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage1');
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage2');
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage3');
    }
    // End:0x5B3
    if(((Health < float(DamageThreshold2)) && bPassedThreshold1) && ! bPassedThreshold2)
    {
        ...
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage1');
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage3');
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage4');
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage5');
        TraceFire(FVar(TimeBetweenDamageEffects, TimeBetweenDamageEffectsVariance), false, 'Damage6');
    }
    return;
}
