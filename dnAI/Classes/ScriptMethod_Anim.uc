/*******************************************************************************
 * ScriptMethod_Anim generated by Eliot.UELib using UE Explorer.exe.
...
{
    return (((((((((((("ExplicitAnim (" $ string(DynamicLoadObject(class'EAIAnimXType', int(AnimType)))) $ ", ") $ string(AnimName)) $ ", ") $ string(UseExactAnimName)) $ ", ") $ string(ExitTime)) $ ", ") $ string(FaceActorTag)) $ ", (") $ string(FacePos)) $ ")") $ ")";
    return;
}
