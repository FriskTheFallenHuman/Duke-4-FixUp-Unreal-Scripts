/*******************************************************************************
 * ScriptMethod_SetHeadTarget generated by Eliot.UELib using UE Explorer.exe.
...
{
    return ((((((((((((((((((("SetHeadTarget (" $ string(TargetActorTag)) $ ", ") $ string(TargetBoneName)) $ ", ") $ string(DynamicLoadObject(class'EAITargetStackOp', int(TargetStackOp)))) $ ", ") $ string(TargetLifeTime)) $ ", ") $ string(BlendTime)) $ ", ") $ string(AngularThresh)) $ ", ") $ string(TrackRate)) $ ", ") $ string(RemoveBeyondConsts)) $ ", ") $ string(SuspendHeadTargetEval)) $ ", ") $ TargetIDString) $ ")";
    return;
}
