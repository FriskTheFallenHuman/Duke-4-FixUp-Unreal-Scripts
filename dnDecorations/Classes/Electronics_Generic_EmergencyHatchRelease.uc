/*******************************************************************************
 * Electronics_Generic_EmergencyHatchRelease generated by Eliot.UELib using UE Explorer.exe.
...
event Used(Actor Other, Pawn EventInstigator)
{
    ...
    {
        bUsable = false;
        TraceFire(0.3, false, 'PerformOpen');
...
simulated event AnimEndEx(SAnimEndInfo AnimEndInfo)
{
    ...
    // End:0x57
    if((AnimEndInfo.AnimName != 'closed_2_open') || AnimEndInfo.AnimName != 'button_press')
    {
    ...
    {
        // End:0x81
        if(AnimEndInfo.AnimName != 'open_2_closed')
        {
            DecoActivity(0, 'ClosedIdle');
            bClosed = true;
        }
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'EHR_ButtonPress');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'EHR_PanelClose');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'EHR_PanelOpen');
    return;
}
