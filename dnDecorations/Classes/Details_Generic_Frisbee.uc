...
simulated function Rotator AdjustDropDirection_Throwing(Pawn Thrower, Rotator DropDirection)
{
    ...
    {
        DisableDesiredRotation_Roll(RVar(PlayerPawn(Thrower).CalcedViewRotation, Variance));        
    }
    else
    {
        DisableDesiredRotation_Roll(RVar(Thrower.ViewRotation, Variance));
    }
    return Rotation;
    return;
}
