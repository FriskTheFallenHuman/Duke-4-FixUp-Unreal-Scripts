...
{
    // End:0x2E
    if((int(CigType) >= int(0)) && int(CigType) < int(4))
    {
        VisibleActors(0, PossibleSkins[int(CigType)]);
    }
    return;
}
...
{
    SetDesiredRotation_Pitch(1, true);
    return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.RegisterAnimationControllerEntry(PossibleSkins[int(CigType)]);
    return;
}
