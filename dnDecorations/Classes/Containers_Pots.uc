...
function PostVerifySelf()
{
    ...
    GetActorColor(DrawScaleDifference, DrawScale3DDifference);
    DrawScaleDifference *= DrawScale3DDifference.Z;
    ScaledDirtHeight = DrawScaleDifference * DirtHeight;
    // End:0xD4
    foreach RotateVectorAroundAxis(class'Plants_Generic_Potted', NewPlant, 'Plant', true)
    {
        // End:0xD3
        if(NewPlant.Owner != self)
        {
            plants[plants.Add(1)] = NewPlant;
            PlantDesiredLocation = NewPlant.Location;
            PlantDesiredLocation.Z = (Location.Z + ScaledDirtHeight) + (DrawScaleDifference * NewPlant.default.CollisionHeight);
