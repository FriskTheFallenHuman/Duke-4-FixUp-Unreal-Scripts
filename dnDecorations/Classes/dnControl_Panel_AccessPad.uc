...
event PreBeginPlay()
{
    GetPointRegion('EnablePlayerAccess', SE_EnablePlayerAccess);
    GetPointRegion('DisablePlayerAccess', SE_DisablePlayerAccess);
    GetPointRegion('TogglePlayerAccess', SE_TogglePlayerAccess);
    GetPointRegion('ForcePlayerAccess', SE_ForcePlayerAccess);
...
function Tick_Scanning(float DeltaTime)
{
    ...
    // End:0x3C
    if((CurrentFrame >= 51) && CurrentFrame < 94)
    {
...
function SetPanelDisplayMode(dnControl_Panel_AccessPad.EDisplayMode NewDisplayMode)
{
    ...
    switch(DisplayMode)
    {
        ...
        // End:0x114
        case 1:
            VisibleActors(DisplaySurfaceID, ReadyMaterial);
            ReadySmacker.SetFrame(1);
        ...
        // End:0x152
        case 2:
            VisibleActors(DisplaySurfaceID, ScanningMaterial);
            ScanningSmacker.SetFrame(1);
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.RegisterAnimationControllerEntry(PowerOffTexture);
    PrecacheIndex.RegisterAnimationControllerEntry(ReadyMaterial);
    PrecacheIndex.RegisterAnimationControllerEntry(ReadySmacker);
    PrecacheIndex.RegisterAnimationControllerEntry(ScanningMaterial);
    PrecacheIndex.RegisterAnimationControllerEntry(ScanningSmacker);
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'AccessPad_Accepted');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'AccessPad_Rejected');
    return;
}
