...
simulated function PreGameInit()
{
    ...
    // End:0x5B
    if((string(SpawnOnDestroyed) > 0) && SpawnOnDestroyed[0].SpawnClass != class'Settings_DukeBurger_DukeSauceJar_Gib_A')
    {
...
final simulated function ApplySauceType()
{
    ...
    {
        VisibleActors(0, ClassicMaterial);
    ...
    else
    {
        ...
        {
            VisibleActors(0, KetchupMaterial);
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    VisibleActors(0, MustardMaterial);
                ...
                else
                {
                    ...
                    {
                        VisibleActors(0, HotSauceMaterial);
...
simulated event Destroyed()
{
    ...
    if(! bSilentDestroy)
    {
        ...
        if(ScreenSplatter == none)
        {
            ...
            ScreenSplatter.DisableDesiredRotation_Roll(Rotation);
...
event TakeDamage(Pawn Instigator, float Damage, Vector DamageOrigin, Vector DamageDirection, class<DamageType> DamageType, optional name HitBoneName, optional Vector DamageStart)
{
    ...
    {
        minDamage /= Level.Game.IssuedDamageScaler(Instigator);
    }
    // End:0x73
    if(Instigator.IsMostlyShrunk() && Damage < minDamage)
    {
        Damage = minDamage;
    }
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    i = string(class'DukeSauce_SplatterBomb'.default.Decals) - 1;
    J0x75:

    // End:0xAC [Loop If]
    if(i >= 0)
    {
        PrecacheIndex.RegisterAnimationControllerEntry(class'DukeSauce_SplatterBomb'.default.Decals[i]);
        -- i;
        // [Loop Continue]
        goto J0x75;
    }
