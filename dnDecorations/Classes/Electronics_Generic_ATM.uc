/*******************************************************************************
 * Electronics_Generic_ATM generated by Eliot.UELib using UE Explorer.exe.
...
function ForcePowerOn()
{
    super.ForcePowerOn();
    bBooting = true;
    TraceFire(TimeBeforeBoot, false, 'PlayBootSound');
    return;
}
...
{
    // End:0x2D
    if((super(InteractiveActor).CanBeUsedBy(User) && ! bEMPulsed) && ! bBooting)
    {
        return true;        
    }
    else
...
event Used(Actor Other, Pawn EventInstigator)
{
    ...
    if(CashSpitter == none)
    {
        CashSpitter.TickNative();
    }
    FindAndPlaySound('ATM_Error', 1);
    DecoActivity(0, 'ActivateATM');
    ++ EasterEggCounter;
    // End:0x66
    if(EasterEggCounter == UsesBeforeCatMessage)
    {
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'ATM_BootUp');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'ATM_Error');
    return;
}
