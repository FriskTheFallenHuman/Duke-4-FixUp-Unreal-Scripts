...
event PostBeginPlay()
{
    ...
    GetPointRegion('CrackNuckles', CrackNucklesTag);
    return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    // End:0x60
    if(NameForString(CrackNucklesTag, 'None'))
    {
...
state() idle
{
    simulated event BeginState()
    {
        ...
        // End:0x9F
        if(bForceAttachCompleteHack && InternalControlRemapper == none)
        {
            ...
            InternalControlRemapper.MountOrigin = Vect(1.5, 0, -41);
            InternalControlRemapper.MountAngles = Rot(0, 0, 0);
