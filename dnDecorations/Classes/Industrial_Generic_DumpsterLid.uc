...
function KarmaSetConstraintProperties(KConstraint ConstraintActor)
{
    ...
    AngularLimit.DetachOscillator(20480);
    AngularLimit.AddSensableClass(true, Rot(AngularLimit.Rotation.Pitch + 20480, AngularLimit.Rotation.Yaw, AngularLimit.Rotation.Roll));
    return;
}
