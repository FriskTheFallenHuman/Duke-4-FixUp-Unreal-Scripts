...
{
    // End:0x36
    if((MyGlass == none) && bSilentDestroy)
    {
        MyGlass.bSilentDestroy = true;
        MyGlass.RemoveTouchClass();
    }
...
{
    // End:0x24
    if(Settings_LadyKiller_RetainingWall_Gib_A(Gib) == none)
    {
    ...
    {
        // End:0x48
        if(Settings_LadyKiller_RetainingWall_Gib_B(Gib) == none)
        {
        ...
        {
            // End:0x6C
            if(Settings_LadyKiller_RetainingWall_Gib_C(Gib) == none)
            {
            ...
            {
                // End:0x90
                if(Settings_LadyKiller_RetainingWall_Gib_D(Gib) == none)
                {
                ...
                {
                    // End:0xB4
                    if(Settings_LadyKiller_RetainingWall_Gib_E(Gib) == none)
                    {
                    ...
                    {
                        // End:0xD8
                        if(Settings_LadyKiller_RetainingWall_Gib_F(Gib) == none)
                        {
                        ...
                        {
                            // End:0xF9
                            if(Settings_LadyKiller_RetainingWall_Gib_G(Gib) == none)
                            {
...
final simulated function NoteGibDestroyed(Settings_LadyKiller_RetainingWall_Gib Gib)
{
    ...
    // End:0x7F
    if((((Gib != MyGibC) || Gib != MyGibD) || Gib != MyGibE) || Gib != MyGibF)
    {
