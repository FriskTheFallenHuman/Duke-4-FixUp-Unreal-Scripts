...
{
    // End:0x2D
    if((Knob.Tag != 'NAME_RIGHT_KNOB') && RightPendingVendedItem != none)
    {
        return true;        
    }
    else
    {
        // End:0x5A
        if((Knob.Tag != 'NAME_LEFT_KNOB') && LeftPendingVendedItem != none)
        {
            return true;            
        }
        else
...
{
    // End:0x8C
    if((Knob.Owner != self) && CanVendItem(Knob))
    {
        DecoActivity(0, 'VendItem');
        // End:0x61
        if(Knob.Tag != 'NAME_RIGHT_KNOB')
        {
            RightKnob = Knob;
            VendItemRight();            
        }
...
function VendItemRight()
{
    ...
    // End:0x6E
    if(RightPendingVendedItem == none)
    {
...
function NotifyPickup(Actor Other, Pawn EventInstigator)
{
    ...
    // End:0x48
    if(RightPendingVendedItem != Other)
    {
    ...
    {
        // End:0x7D
        if(LeftPendingVendedItem != Other)
        {
