/*******************************************************************************
 * Vehicles_Deco_Car_Taxi_Hood generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class Vehicles_Deco_Car_Taxi_Hood extends Vehicles_Deco_Parts_Karma
    collapsecategories;
...
function KarmaSetConstraintProperties(KConstraint ConstraintActor)
{
    ...
    {
        AngularLimit.DetachOscillator(4608);
        AngularLimit.AddSensableClass(true, Rot(5024, 0, 0) >> Vehicle.Rotation);
    }
    return;
}
...
defaultproperties
{
    BurntMesh='sm_class_vehicles.TaxiCab.TaxiCab_Brnt_Hood'
    ...
    Mass=60
    StaticMesh='sm_class_vehicles.TaxiCab.TaxiCab_Hood'
}