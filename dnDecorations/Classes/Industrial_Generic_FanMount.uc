...
function PostVerifySelf()
{
    ...
    FanRampUpTime = FMax(1E-05, FanRampUpTime);
    FanRampDownTime = FMax(1E-05, FanRampDownTime);
    // End:0x7C
    foreach RotateVectorAroundAxis(class'Industrial_Generic_Fan_Mounted', MyFan,, true)
    {
        // End:0x7B
        if(MyFan.Owner != self)
        {
