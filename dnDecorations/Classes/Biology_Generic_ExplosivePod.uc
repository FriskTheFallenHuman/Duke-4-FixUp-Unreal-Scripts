...
function TelekineticThrow(Vector Vel, bool bConstrain)
{
    ...
    TraceFire(0.1, false, 'TKThrowDamageEnable');
    return;
}
...
function ThrowLanded()
{
    ...
    // End:0x22
    if(! UnderTelekineticControl || BeingTelekineticThrown)
    {
        CriticalDamage();
    }
    return;
...
simulated event Tick(float DeltaSeconds)
{
    ...
    {
        RemoveActorColor(DrawScale + ((DeltaSeconds / SpawnInTime) * SpawnInTime));        
    }
    else
    {
        // End:0x86
