...
simulated function SpawnMountedParticleSystems()
{
    ...
    if(ParticleSystemClass == none)
    {
        ...
        MountOnSpawn[Index].MountPrefab.ForceTag = CompositeNames("MainPodFX");
    }
    // End:0x197
    if(ParticleBurstSystemClass == none)
    {
        Index = MountOnSpawn.Add(1);
        ...
        MountOnSpawn[Index].MountPrefab.MountOrigin.Y = 0;
        MountOnSpawn[Index].MountPrefab.MountOrigin.Z = 7;
        MountOnSpawn[Index].MountPrefab.ForceTag = CompositeNames("BurstPodFX");
    }
    // End:0x1E1
...
function PodAction(Actor Other)
{
    ...
    if(Other.bIsPawn && ! CoolingDown)
    {
        P = Pawn(Other);
        // End:0xF4
        if(! IsMP() || P.CanShrink(class'ShrinkerDamage') && int(P.Role) == int(ROLE_Authority))
        {
            // End:0xF4
            if(! P.PhysController_SetGroundConstraintDirection())
            {
                ...
                TraceFire(ParticleCoolDown, false, 'TurnParticlesOn');
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.RegisterMaterialClass(ParticleBurstSystemClass);
