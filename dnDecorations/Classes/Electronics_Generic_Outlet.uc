/*******************************************************************************
 * Electronics_Generic_Outlet generated by Eliot.UELib using UE Explorer.exe.
...
simulated event Used(Actor Other, Pawn EventInstigator)
{
    ...
    if(EventInstigator == none)
    {
        ...
        EventInstigator.TakeDamage(none, DamageAmount, Vect(0, 0, 0), Vect(0, 0, 0), class'ElectricalDamage',, Location);
    }
    return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.SetAnimPairState('HandQuickAction_Switch_FingerPush');
    PrecacheIndex.ResetServer(class'ElectricalDamage');
    return;
}
