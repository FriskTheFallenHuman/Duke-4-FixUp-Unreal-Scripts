...
final simulated function MakeCopy()
{
    ...
    {
        PrintingPage = dnControlHelper_Copier_PrintedPage(MountedActorList[string(MountedActorList) - 1].MountedActor);
    }
    // End:0x62
    if(PrintingPage == none)
    {
        PrintedPageSpawned();
    }
    // End:0x8A
...
{
    // End:0x13
    if(GetAnimMovement() || bMakingCopy)
    {
        return false;
    }
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.RegisterAnimationControllerEntry(BrokenMat);
    return;
}
