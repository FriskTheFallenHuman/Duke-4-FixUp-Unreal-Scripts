/*******************************************************************************
 * Vehicles_Deco_Car_Police_Door_Front_Left generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class Vehicles_Deco_Car_Police_Door_Front_Left extends Vehicles_Deco_Car_Standard_Door
    collapsecategories;
...
function KarmaSetConstraintProperties(KConstraint ConstraintActor)
{
    ...
    if(AngularLimit == none)
    {
        ...
        AngularLimit.AddSensableClass(true, Rot(0, 39424, 0) >> Vehicle.Rotation);
    }
    return;
}
...
defaultproperties
{
    BurntMesh='sm_class_vehicles.PoliceCar_A.PoliceCarA_Brnt_FrntDoorL'
