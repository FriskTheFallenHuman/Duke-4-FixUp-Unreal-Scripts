...
simulated event PostVerifySelf()
{
    ...
    ConstVel = PhysicsAction_ConstVel(ProcessSpawnActorPrefab(class'PhysicsAction_ConstVel', true));
    // End:0x38
    if(ConstVel == none)
    {
...
final simulated function FlipUp()
{
    ...
    if(bLeftFlipper)
    {
        ConstVel.Setup(false, true,, Vect(0, 0, -30));        
    }
    else
    {
        ConstVel.Setup(false, true,, Vect(0, 0, 30));
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Pinball_FlipUp');
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Pinball_FlipDown');
    return;
}
