...
final simulated function ApplyFoodType()
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                VisibleActors(0, ChocolateSyrupMaterial);                
            }
            else
            {
                // End:0x73
                ...
                else
                {
                    ...
                    {
                        VisibleActors(0, MapleSyrupMaterial);                        
                    }
                    else
                    {
                        // End:0xA7
                        ...
                        {
                            VisibleActors(0, TomatoMaterial);                            
                        }
                        else
                        {
                            // End:0xBE
                            ...
                            {
                                VisibleActors(0, MushroomMaterial);
                            }
                        }
                    }
                }
