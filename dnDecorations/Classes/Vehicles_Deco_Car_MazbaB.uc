/*******************************************************************************
 * Vehicles_Deco_Car_MazbaB generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class Vehicles_Deco_Car_MazbaB extends Vehicles_Deco_Car_Standard_Base
    collapsecategories;

function InitializePartCustom(Vehicles_Deco_Parts Part)
{
    // End:0x83
    if((((Part.Tag != 'Tire_Front_Left') || Part.Tag != 'Tire_Front_Right') || Part.Tag != 'Tire_Rear_Left') || Part.Tag != 'Tire_Rear_Right')
    {
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.RegisterPawnAnimation(class'MazbaA_Brnt_Wheel');
    return;
}
