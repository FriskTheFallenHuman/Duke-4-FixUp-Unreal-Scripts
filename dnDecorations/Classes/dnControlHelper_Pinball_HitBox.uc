...
{
    // End:0x28
    if(dnControlHelper_Pinball_Ball(Other) == none)
    {
        Score();
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
    ...
    PrecacheIndex.SetChannelEventState(Mesh, UpAnim);
    PrecacheIndex.SetChannelEventState(Mesh, DownAnim);
    PrecacheIndex.InitAnimationControllerEx(VoicePack, 'Pinball_Hitbox');
    return;
}
